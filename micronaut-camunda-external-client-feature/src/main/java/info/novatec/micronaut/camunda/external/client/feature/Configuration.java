...
public interface Configuration {
    ...
    /**
     * Disables immediate fetching for external tasks after building the client. To start fetching
     * ExternalTaskClient.start() must be called.
     *
     * @return if auto fetching should be disabled
     */
